 ...
 */
    ...
    public function writeoff_items($start_date,$end_date,$user_id)
    {
...
order by store_journal.uniq_num asc, store_journal.item_id asc*/
        //$where=
        $this->db->select('store_journal.uniq_num, registr_cartridge.name as cart_name, store_it.name as item_name, store_journal.amount, store_journal.item_id, invoices.price')
                ->from('store_journal')
                ...
                ->order_by('store_journal.uniq_num','asc')
